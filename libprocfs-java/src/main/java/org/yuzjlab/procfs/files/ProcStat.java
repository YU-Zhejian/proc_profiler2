...
public class ProcStat {
     ...
     *
     * <p>The CPU will not wait for I/O to complete; iowait is the time that a task is waiting for
     * I/O to complete. When CPU goes into idle state for outstanding task I/O, another task will be
     * scheduled on this CPU.
     *
     * <p>On a multi-core CPU, the task waiting for I/O to complete is not running on any CPU, so
     * the iowait of each CPU is difficult to calculate.
     *
        ...
        try {
            ...
            throw new ProcessBaseException(
                    new RuntimeException(
                            "proc/stat file contains illegal %s line ('%s')!"
