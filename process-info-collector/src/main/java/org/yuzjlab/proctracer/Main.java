...
class FEOpts {
    ...
    public static final Option helpOption = Option
            ...
            .hasArg(false)
            .build();
    public static final Option pidOption = Option
            .builder("p")
            .longOpt("pid")
            ...
            .hasArg(true)
            .build();
    public static final Option compressOption = Option
            .builder()
            .longOpt("compress")
            ...
            .hasArg(true)
            .build();
    public static final Option wdOption = Option
            .builder()
            .longOpt("wd")
            ...
            .hasArg(true)
            .build();
    public static final Option outdirOption = Option
            .builder("o")
            .longOpt("outdir")
            ...
            .hasArg(true)
            .build();
    public static final Option frontendRefreshFreqOption = Option
            .builder()
    ...
    public static final Option backendRefreshFreqOption =
            Option
                    ...
                    .hasArg(true)
                    .build();
    public static final Option supressFrontendOption = Option
            .builder()
            ...
            .hasArg(false)
            .build();
    public static final Option configOption = Option
            .builder("c")
            .longOpt("config")
            ...
            .hasArg(true)
            .build();
    protected static final String streamDesc = "File path of the standard %s stream to be redirected to the target process. " +
            "Only valid if [CMDS] are present. Default to `/dev/null`.";
    public static final Option stdinOption = Option
            .builder()
            .longOpt("stdin")
    ...
    public static final Option stdoutOption =
            Option
                    ...
                    .hasArg(true)
                    .build();
    public static final Option stderrOption = Option
            .builder()
            .longOpt("stderr")
...
public class Main {
    ...
    public static Pair<ProcessSupervisorThreadInterface, TracerOpts> parseArgs(String[] argsBeforeCmdLineArr, String[] cmdLineArr) throws ParseException {
